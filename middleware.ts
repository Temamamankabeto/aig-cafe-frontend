...
const ROUTE_ROLE_RULES: AccessRule[] = [
  ...
  { prefixes: ["/dashboard/cafeteria-manager"], roles: ["Manager", ADMIN] },
  { prefixes: ["/dashboard/fb-controller"], roles: ["F&B Controller", ADMIN] },
  { prefixes: ["/dashboard/finance-manager"], roles: ["Finance", ADMIN] },
  { prefixes: ["/dashboard/stock-keeper"], roles: ["Store Keeper", ADMIN] },
  { prefixes: ["/dashboard/purchaser"], roles: ["Purchaser", ADMIN] },
  { prefixes: ["/dashboard/cashier"], roles: ["Cashier", ADMIN] },
